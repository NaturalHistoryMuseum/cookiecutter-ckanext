...
## Documentation
- [{{ cookiecutter.slug }} documentation](https://{{ cookiecutter.slug }}.readthedocs.io)
...
## Issues
- [Issues for {{ cookiecutter.slug }}](https://github.com/NaturalHistoryMuseum/{{ cookiecutter.slug }}/issues)
